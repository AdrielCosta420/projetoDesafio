...
final _entities = <ModelEntity>[
  ModelEntity(
      id: const IdUid(1, 6370282957961406734),
      name: 'User',
      lastPropertyId: const IdUid(7, 8405182183325870095),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 977803433950074511),
            name: 'id',
            type: 6,
            flags: 1),
        ModelProperty(
            id: const IdUid(2, 8599803475283532664),
            name: 'nome',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(3, 8179174286320497181),
            name: 'dataNascimento',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(4, 7239964153198183627),
            name: 'apelido',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(5, 6650681163260476096),
            name: 'email',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(6, 4182992379160886285),
            name: 'celular',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(7, 8405182183325870095),
            name: 'avatarUrl',
            type: 9,
            flags: 0)
      ],
...
ModelDefinition getObjectBoxModel() {
  final model = ModelInfo(
      entities: _entities,
      lastEntityId: const IdUid(1, 6370282957961406734),
